...
jobs 명령어는 작업의 상태를 표시하는 명령어입니다. 현재 쉘 세션에서 실행시킨 백그라운드 작업의 목록이 출력되며, 각 작업에는 변화가 붙어 있어 kill 명령어 뒤에 '%번호' 등으로 사용할 수 있습니다. 
...
예를들어 node.js로 실행 중인 서버를 죽이고 싶다면 ps 명령어를 통해 node.js의 pid를 얻고 kill 명령어의 파라미터로 넘겨 실행시키면 종료시킬 수 있습니다.
  ...
  <img width="700" alt="kill 1" src="https://user-images.githubusercontent.com/106795349/172013415-ab6eea08-17c7-40ac-bfce-1aa0d57f285e.png">

## ***사용자 지정 시그널 전송 방법***
  
-l (List의 엘) 명령어를 통해 지원하는 시그널의 목록을 확인할 수 있습니다.
  
<img width="700" alt="kil 2" src="https://user-images.githubusercontent.com/106795349/172013605-09b42339-9700-4ea6-ba66-e84be4e636d2.png">
...
> ### 기본적인 매크로 사용 방법 커맨드 모드 (esc 누른 상태) 에서
...
>> 1) 첫 번째 방법: 편집 모드에서 ctrl + r, ctrl + r, 매크로 문자  를 순서대로 입력하면 그대로 출력된다.
>> 2) 두 번째 방법: 커맨드 모드에서 "매크로문자p 를 입력하여 래지스터로부터 바로 붙여넣기 한다. (ex: "ap, "bp, "cp, "dp, ...)
 
